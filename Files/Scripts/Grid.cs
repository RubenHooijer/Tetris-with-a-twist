...
/// <summary>
/// To create a grid and save the position of the blocks within the created grid
/// </summary>
...
public class Grid : Iinitialize
{
    ...
    //Returns the coordinate next to(based on direction) _coordinate is 
    ...
    //Fires off all the blocks, by adding a Rigidbody with random velocity
    public void Destroy()
    {
        for (int i = 0; i < gridSize.y; i++)
        {
